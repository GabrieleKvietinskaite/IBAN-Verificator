(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(formBuilder, ibanService) {
                ...
                Object.defineProperty(HomeComponent.prototype, "fIban", {
                    get: function () {
                ...
                Object.defineProperty(HomeComponent.prototype, "fIbans", {
                    get: function () {
                ...
                HomeComponent.prototype.checkIban = function () {
                    var _this = this;
                    this.submitted = true;
                    if (this.ibanForm.invalid) {
                        return;
                    }
                    this.ibanService.getIban(this.fIban.iban.value).subscribe(function (data) {
                        _this.ibans = [];
                        _this.ibans.push(data);
                    });
                };
                HomeComponent.prototype.checkIbans = function () {
                    var _this = this;
                    this.submitted = true;
                    if (this.ibansForm.invalid) {
                        return;
                    }
                    var ibans = this.fIbans.ibans.value.split(":").filter(function (iban) {
                        return iban.length > 0;
                    });
                    this.ibanService.getIbans(ibans).subscribe(function (data) {
                        _this.ibans = data;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var IbanService = /** @class */ (function () {
                function IbanService(httpClient) {
                ...
                IbanService.prototype.getIban = function (iban) {
                    var url = "/iban";
                    var body = JSON.stringify(iban);
                    return this.httpClient.post(this.REST_API_SERVICE + url, body, this.httpOptions);
                };
                IbanService.prototype.getIbans = function (ibans) {
                    var url = "/ibans";
                    var body = JSON.stringify(ibans);
                    return this.httpClient.post(this.REST_API_SERVICE + url, body, this.httpOptions);
                };
                IbanService.prototype.handleError = function (error) {
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(error);
                };
                return IbanService;
            }());
            IbanService.ctorParameters = function () { return [
